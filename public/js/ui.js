...
const showChatCallElements = () => {
  const finishConnectionButtonContainer = document.getElementById(
    "finish_chat_button_container"
  );
  showElement(finishConnectionButtonContainer);
...
export const showRecordingPanel = () => {
  ...
  // hide start recording if active
